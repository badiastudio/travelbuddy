...
const styles = StyleSheet.create({
  ...
  dayChipsRow: { maxHeight: 44, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#E5E7EB' },
  dayChipsContent: { paddingHorizontal: 12, paddingVertical: 8, gap: 8, flexDirection: 'row' },
  dayChip: { paddingHorizontal: 14, paddingVertical: 5, borderRadius: 14, borderWidth: 1.5, borderColor: '#D1D5DB', backgroundColor: '#F9FAFB' },
